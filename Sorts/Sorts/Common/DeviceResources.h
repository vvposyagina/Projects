...
namespace DX
{
    // Предоставляет интерфейс для приложения, владеющего DeviceResources, чтобы можно было получать уведомления о потере или создании устройства.
	...
	private:
		...
		// Объекты отрисовки Direct3D. Требуются для трехмерной отрисовки.
		...
		// IDeviceNotify можно сохранять напрямую, поскольку он владеет DeviceResources.
