...
// Инициализирует ресурсы D2D, используемые для отрисовки текста.
...
void SampleFpsTextRenderer::Render()
{
	...
	// Здесь мы игнорируем D2DERR_RECREATE_TARGET. Эта ошибка указывает, что устройство
